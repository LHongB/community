...
export default {
    ...
    mounted:function(){
      ...
      this.$axios('/users/CComent/' + id).then((res)=>{
          console.log(res);
        //   console.log(res.data.comments.reply_id);
          this.author = res.data.comments.author._id;
          this.reply_id = res.data.comments.reply_id;
      })
    },
methods:{

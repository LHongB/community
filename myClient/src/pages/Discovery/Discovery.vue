...
<div class="discovery">
  ...
  <div class="search-bar-wrapper">
    ...
    <form class="search-form" action="" method="get">
      <input @focus="focusSearchBar" @change="search()" :class="{'search-bar-active':searchBarOnFocus}" type="search" class="search-bar" placeholder="搜索">
  ...
  <div v-show="searchBarOnFocus" class="hot-search card">
    ...
    <section class="list-card card">
      <ul>
        <li class="hot-search-li"><a>___</a></li>
        <li class="hot-search-li"><a>___</a></li>
        <li class="hot-search-li"><a>___</a></li>
...
export default {
  ...
  methods: {
        ...
        var that = this 
          ...
          this.$store.commit('setSearch',data.data.articles)
